...
def get_search_result(url, title, description, soup=None):
    return_dict = {
        'url': url,
        'title': title,
...
def search(term, num_results=3, lang="en", proxy=None, sleep_interval=1):
        ...
        for result in result_block:
            ...
            if description_box:
                ...
                if link and title and description:
                    ...
                    result_list.append(get_search_result(link['href'], title.text, description.text))
